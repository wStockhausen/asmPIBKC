...
//Note: Using Makevars in /Users/WilliamStockhausen/.R/Makevars 
//clang++ -I"/Library/Frameworks/R.framework/Resources/include" -DNDEBUG -I"/Users/WilliamStockhausen/Work/Programming/R/Library/TMB/include" -I"/Users/WilliamStockhausen/Work/Programming/R/Library/RcppEigen/include"  -DTMB_SAFEBOUNDS -DTMB_EIGEN_DISABLE_WARNINGS -DLIB_UNLOAD=R_unload_tmbRWM  -DTMB_LIB_INIT=R_init_tmbRWM  -DCPPAD_FRAMEWORK  -I/usr/local/include   -fPIC  -std=c++11 -c tmbRWM.cpp -o tmbRWM.o
//clang++ -dynamiclib -Wl,-headerpad_max_install_names -undefined dynamic_lookup -single_module -multiply_defined suppress -L/Library/Frameworks/R.framework/Resources/lib -L/usr/local/lib -o tmbRWM.so tmbRWM.o -F/Library/Frameworks/R.framework/.. -framework R -Wl,-framework -Wl,CoreFoundation

//--Current compiler output for reg_simple_sn.cpp (see Testing/SkewNormal)
// Note: Using Makevars in /Users/WilliamStockhausen/.R/Makevars 
// clang++ -I"/Library/Frameworks/R.framework/Resources/include" -DNDEBUG -I"/Users/WilliamStockhausen/Work/Programming/R/Library/TMB/include" -I"/Users/WilliamStockhausen/Work/Programming/R/Library/RcppEigen/include"  -DTMB_SAFEBOUNDS -DTMB_EIGEN_DISABLE_WARNINGS -DLIB_UNLOAD=R_unload_reg_simple_sn  -DTMB_LIB_INIT=R_init_reg_simple_sn  -DCPPAD_FRAMEWORK  -I/usr/local/include   -fPIC  -std=c++11 -c reg_simple_sn.cpp -o reg_simple_sn.o
// clang++ -dynamiclib -Wl,-headerpad_max_install_names -undefined dynamic_lookup -single_module -multiply_defined suppress -L/Library/Frameworks/R.framework/Resources/lib -L/usr/local/lib -o reg_simple_sn.so reg_simple_sn.o -F/Library/Frameworks/R.framework/.. -framework R -Wl,-framework -Wl,CoreFoundation
